<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO Employees (Staff_Name,Address,Phone_Number,Email,Pay,Hire_Date,Emergency_Info,Birthday,Notes) values(?, ?, ?, ?, ?, ?, ?, ?, ?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($name,$address,$phone_number,$email,$pay,$hiredate,$emergencyinfo,$birthday,$notes));
			Database::disconnect();
...
<body>
    <div class="container">
    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="employee_create.php" method="post">
