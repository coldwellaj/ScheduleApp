    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="shift_update.php?id=<?php echo $id?>" method="post">
					  <div class="control-group <?php echo !empty($staffError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="Staff_Id" type="text"  placeholder="Staff_Id" value="<?php echo !empty($staff)?$staff:'';?>">
					      	<?php if (!empty($staffError)): ?>
					      		<span class="help-inline"><?php echo $staffError;?></span>
					      	<?php endif; ?>
					    </div>
					  </div>
					  <div class="control-group <?php echo !empty($clientError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="Client_Id" type="text" placeholder="Client_Id" value="<?php echo !empty($client)?$client:'';?>">
